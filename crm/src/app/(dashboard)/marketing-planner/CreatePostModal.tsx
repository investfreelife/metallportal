    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-lg shadow-2xl w-full max-w-lg">
        ...
        <div className="px-4 py-4 space-y-3 max-h-[70vh] overflow-y-auto">
          ...
          <div>
            <label className="text-[11px] font-medium text-gray-500 uppercase tracking-wide">Метка варианта (опц.)</label>
            <input
              value={label}
              onChange={(e) => setLabel(e.target.value)}
              placeholder="Короткое имя для админки (A/B/C, «Лето · оффер 1»)"
              className="mt-1 w-full px-2.5 py-1.5 text-sm border border-gray-200 rounded-md focus:border-blue-500 focus:outline-none"
            />
          </div>
          ...
          <div>
            ...
            />
            <div className="text-[10px] text-gray-400 mt-1">{text.length} симв.</div>
          </div>
