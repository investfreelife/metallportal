...
export function KanbanBoard({ leads: initial }: { leads: Lead[] }) {
  ...
  // TASK_018: сводка по нишам (количество лидов в каждой канонической нише)
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-shrink-0 px-5 pt-5 pb-3">
        ...
        {/* TASK_018: фильтр по нише + счётчики */}
                    ...
                    items.map((lead) => (
                      <article key={lead.id}
                        ...
                        <Link href={`/dream/leads/${lead.slug}`} className="block">
                          ...
                          {/* TASK_018: бейдж ниши вместо серой подписи */}
                          {(() => {
