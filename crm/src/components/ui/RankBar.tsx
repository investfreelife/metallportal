...
export function RankBar({ label, value, max, color, suffix = '', onClick }: RankBarProps) {
  ...
  return (
    <div
      ...
      onClick={onClick}
    >
      <div className="text-[11px] text-gray-600 w-[100px] flex-shrink-0 truncate">{label}</div>
      ...
      <div className="text-[11px] font-medium text-gray-700 w-10 text-right flex-shrink-0">
