...
const CARD_DEFAULTS = [
  // TASK_054 (audit 2026-06-18 SEV-1): единая цифра каталога — 12 000+.
  // Раньше 1200+ (тут) / 1500+ (TrustCounters) / 12000+ (Header/about/ai-search) —
  // читается как «приукрашивают». Реальная: 12166 SKU.
  { title: "Металлопрокат", sub: "Трубы · Арматура · Лист · Балки · Уголок", link: "12 000+ позиций →",
