...
- [ ] Импорт 12166 товаров (в процессе)
- [ ] SEO карточки через GPT-4o-mini
- [ ] Фото через fal.ai
...
Завершить импорт товаров из data/catalog_full.json
Запустить: npx tsx scripts/generate_cards.ts
