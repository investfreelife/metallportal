...
- seo_title: SEO заголовок для <title>, СТРОГО до 60 символов. Формат: "{Название} купить в Москве | Харланметалл"
...
- seo_text: Полный SEO текст карточки товара в формате HTML (400-500 слов). Структура:
  ...
  <h3>Как купить {название} в Харланметалл</h3>
...
8. Не выдумывай цены — пиши "по запросу" или "уточняйте"`;
  ...
  return `Ты — SEO-копирайтер интернет-магазина металлопроката Харланметалл (metallportal.vercel.app).
...
async function main() {
  ...
  console.log("═══════════════════════════════════════════════════");
  console.log("  Харланметалл — SEO Card Generator");
  console.log("═══════════════════════════════════════════════════\n");
