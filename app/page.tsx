    ...
    <>
      ...
      <section className="bg-background py-14">
        <div className="container-main">
          ...
          <p className="text-muted-foreground leading-relaxed mb-6 max-w-4xl">
            Харланметалл предлагает более 1 500 позиций металлопроката промышленного и строительного назначения. В постоянном наличии на складе — наиболее востребованные виды проката:
          </p>
      ...
      <section className="bg-background py-12">
        <div className="container-main">
          ...
          <p className="text-muted-foreground leading-relaxed mb-6">
            Помимо продажи проката, Харланметалл оказывает полный спектр услуг по металлообработке прямо на складе:
          </p>
          ...
          <p className="text-muted-foreground leading-relaxed italic max-w-4xl">
            Если вы затрудняетесь с подбором продукции — опытные менеджеры Харланметалл помогут выбрать оптимальный вариант по наименованиям, размерам и комплектации под ваши конкретные задачи.
          </p>
        </div>
      </section>
      ...
      <section className="bg-background py-12">
        <div className="container-main">
          ...
          <p className="text-muted-foreground leading-relaxed mb-6 max-w-4xl">
            Харланметалл не просто продаёт металл — мы изготавливаем готовые металлоконструкции любой сложности по чертежам, эскизам или техническому заданию заказчика. Собственное производственное подразделение позволяет выполнять заказы в сжатые сроки с контролем качества на каждом этапе.
          </p>
      ...
      <section className="bg-background py-12">
        <div className="container-main">
          ...
          <p className="text-muted-foreground leading-relaxed mb-3 max-w-4xl">
            Харланметалл осуществляет доставку продукции собственным автотранспортом по Москве и Московской области — прямо с нашего склада до вашего объекта или склада. Стоимость доставки рассчитывается исходя из грузоподъёмности транспортного средства и удалённости точки разгрузки от МКАД.
          </p>
          <p className="text-muted-foreground leading-relaxed mb-3 max-w-4xl">
